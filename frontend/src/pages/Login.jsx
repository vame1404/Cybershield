        ...
        <div className="min-h-[80vh] flex items-center justify-center">
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-3xl font-display font-bold text-cyber-text">Access Portal</h2>
                    <p className="text-cyber-muted mt-2">Authenticate to continue</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input 
                                ...
                                className="w-full bg-cyber-bg border border-cyber-border rounded-lg py-2 pl-10 pr-4 text-cyber-text focus:outline-none focus:border-cyber-primary transition-colors"
                    ...
                    <div>
                        <label className="block text-cyber-muted text-sm mb-1">Passcode</label>
                        <div className="relative">
                    ...
                    <button 
                        disabled={loading}
                        type="submit"
                        className="w-full py-3 rounded-lg bg-cyber-primary text-cyber-bg font-bold hover:opacity-90 transition-opacity flex items-center justify-center gap-2 mt-6"
                    >
                        {loading ? <Loader2 className="animate-spin w-5 h-5" /> : 'INITIALIZE UPLINK'}
                    </button>
                </form>
                ...
                <div className="mt-6 text-center text-cyber-muted text-sm">
                    No clearance? <Link to="/signup" className="text-cyber-primary hover:underline">Request access</Link>
                </div>
            </motion.div>
        </div>
    );
