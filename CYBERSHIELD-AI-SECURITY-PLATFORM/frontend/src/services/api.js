...
export const deepfakeAPI = {
  analyzeImage: (files) => {
    ...
    return api.post('/api/v1/deepfake/analyze/image', formData, {
  ...
  analyzeVideo: (file) => {
    ...
    return api.post('/api/v1/deepfake/analyze/video', formData, {
      headers: { 'Content-Type': 'multipart/form-data' },
    })
  },
...
export const phishingAPI = {
  analyzeURL: (url) => api.post('/api/v1/phishing/analyze', { url }),
