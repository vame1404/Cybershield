...
import { Upload, ImageIcon, Loader2, AlertTriangle, CheckCircle, Search, XCircle } from 'lucide-react'
import { aiGeneratedAPI } from '../services/api'
...
export default function AIGeneratedDetection() {
    ...
    const analyzeFiles = async () => {
        ...
        try {
            const { data } = await aiGeneratedAPI.analyzeImage(files)
        ...
        <div className="space-y-6 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="glass-card p-6 col-span-1">
                    ...
                    >
                        {isAnalyzing ? <><Loader2 className="animate-spin" /> Deep Scanning...</> : <><Search /> Analyze {files.length > 1 ? `${files.length} Images` : 'Image'}</>}
                    </button>
